  ...
  <head>
    ...
    <section class="h-100 w-100 p-3" style="box-sizing: border-box; background-color:#252332">
        ...
        <div class="d-flex mx-auto align-items-left justify-content-left width-right mx-lg-0">
            ...
            <form style="margin-top: 1.5rem;" action="update_password_user.php" method="post">
                ...
                <div style="margin-bottom: 1.75rem;">
                <label for="exampleInputEmail1" class="d-block input-label">New Password</label>
                <div class="d-flex w-100 div-input">
                    <svg class="icon" style="margin-right: 1rem;" width="24" height="24" viewBox="0 0 24 24" fill="none"
                    xmlns="http://www.w3.org/2000/svg">
                    <path fill-rule="evenodd" clip-rule="evenodd"
                    ...
                    <input class="input-field" type="password" value="" name="password" id="exampleInputEmail1" placeholder="New Password" autocomplete="on"
                    >
                </div>
                </div>
                <div style="margin-bottom: 1.75rem;">
                <label for="exampleInputEmail1" class="d-block input-label">Confirm Password</label>
                <div class="d-flex w-100 div-input">
                    <svg class="icon" style="margin-right: 1rem;" width="24" height="24" viewBox="0 0 24 24" fill="none"
                    xmlns="http://www.w3.org/2000/svg">
                    <path fill-rule="evenodd" clip-rule="evenodd"
                    ...
                    <input class="input-field" type="password" value="" name="konfirmasi_password" id="exampleInputEmail1" placeholder="Confirm Password" autocomplete="on"
                    >
                </div>
                </div>
