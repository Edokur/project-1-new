    ...
    echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" method="post">
            <div style="margin-bottom: 1.75rem;">   
                    ...
                    <div class="d-flex w-100 div-input">
                        ...
                        <input class="input-field" type="text" value="<?php echo $nama; ?>" name="nama_user" id="exampleInputEmail1" placeholder="Your Fullname" autocomplete="on"
                        >
                    </div>
                ...
                <div style="margin-bottom: 1.75rem;">
                    ...
                    <div class="d-flex w-100 div-input">
                        ...
                        <input class="input-field" type="text" value="<?php echo $user; ?>" name="username_user" id="exampleInputEmail1" placeholder="Your Username" autocomplete="on"
                        >
                    </div>
                ...
                <div style="margin-bottom: 1.75rem;">
                    ...
                    <div class="d-flex w-100 div-input">
                        ...
                        <input class="input-field" type="email" value="<?php echo $email; ?>" name="email_user" id="exampleInputEmail1" placeholder="Your Email Address" autocomplete="on"
                        >
                    </div>
