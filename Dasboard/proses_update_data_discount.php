...
if ($diskonProduk > 10) {
  ...
  if(!in_array($ext, $ekstensi) ) {
    ...
    if($ukuran < 10000000){		
      $xx = $rand.'_'.$filename;
      $sql = "UPDATE discount_produk SET kode_produk='$kodeProduk', nama_produk='$namaProduk', harga_awal='$hargaAwalProduk', harga_produk='$hargaProduk',diskon_produk='$diskonProduk', stock_produk='$stockProduk', detail_produk='$detailProduk', foto_produk='$xx' WHERE id_produk='$idProduk'";
