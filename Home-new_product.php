        ...
        <div class="header-3-2 container-xxl mx-auto p-0 position-relative" style="font-family: 'Poppins', sans-serif">
                        ...
                        <div class="modal-body" style="padding: 2rem; padding-top: 0; padding-bottom: 0">
                                <ul class="navbar-nav responsive me-auto mt-2 mt-lg-0">
                                        ...
                                        <li class="nav-item dropdown">
                                                ...
                                                <li><a class="dropdown-item " href="Home-old_product.php">Old Product</a></li>
                                                </ul>
                                        </li>
                ...
                <div class="collapse navbar-collapse" id="navbarTogglerDemo">
                        ...
                        <li class="nav-item dropdown">
                                ...
                                <ul class="dropdown-menu dropdown-menu-dark" aria-labelledby="navbarDarkDropdownMenuLink">
                                        <li class="">
                                                <a class="dropdown-item" href="" style="color: rgba(91, 203, 173, 1);">New Product</a>
                                        </li>
                                        <li>
                                                <a class="dropdown-item" href="Home-discount_product.php">Discount Product</a>
                                        </li>
                                        <li>
                                                <a class="dropdown-item" href="Home-old_product.php">Old Product</a>
                                        </li>
                                </ul>
                        </li>
                        <li class="nav-item position-relative">
                ...
                <div class="row row-cols-1 row-cols-md-3 g-4 my-3 px-3">
                        ...
                        <div class="col">
                                ...
                                <div class="card-body mt-3">
                                        ...
                                        <p class="card-text text-secondary"><?php echo $r['detail_produk']; ?></p>
                                        <p class="card-text fs-5 text-danger"><?php echo "Rp. ".number_format($r['harga_produk']); ?></p>
